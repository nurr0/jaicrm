...
class SalesResource(resources.ModelResource):
    ...
    sales_channel = Field(attribute='receipt__sales_channel', column_name='Канал продаж')
    payment_form = Field(attribute='receipt__payment_form', column_name='Способ оплаты')
